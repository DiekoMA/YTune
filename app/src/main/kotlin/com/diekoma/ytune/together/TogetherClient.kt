...
package com.diekoma.ytune.together
...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.diekoma.ytune.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.diekoma.ytune.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.diekoma.ytune.together.JoinDecision -> {
