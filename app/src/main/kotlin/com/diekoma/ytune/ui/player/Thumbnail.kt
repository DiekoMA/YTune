...
import com.diekoma.ytune.canvas.ArchiveTuneCanvas
import com.diekoma.ytune.canvas.CanvasArtwork
...
import com.diekoma.ytune.constants.PlayerHorizontalPadding
...
import com.diekoma.ytune.constants.MaxCanvasCacheSizeKey
...
fun Thumbnail(
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.diekoma.ytune.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.diekoma.ytune.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
