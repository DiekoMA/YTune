...
import com.diekoma.ytune.constants.QueueEditLockKey
...
import com.diekoma.ytune.ui.component.MediaMetadataListItem
import com.diekoma.ytune.ui.menu.PlayerMenu
import com.diekoma.ytune.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.diekoma.ytune.together.TogetherSessionState.Joined &&
            (togetherSessionState as com.diekoma.ytune.together.TogetherSessionState.Joined).role is com.diekoma.ytune.together.TogetherRole.Guest
                                            ...
                                            onClick = {
                                                if (selection) {
                                                    ...
                                                    if (index == currentWindowIndex) {
                                                        ...
                                                        val joined =
                                                            togetherSessionState as? com.diekoma.ytune.together.TogetherSessionState.Joined
                                                        val isGuest = joined?.role is com.diekoma.ytune.together.TogetherRole.Guest
                                                        if (isGuest) {
