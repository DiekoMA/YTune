...
import com.diekoma.ytune.utils.PreferenceStore
import kotlinx.coroutines.withContext
import com.diekoma.ytune.constants.AppBarHeight
import com.diekoma.ytune.constants.AppLanguageKey
import com.diekoma.ytune.constants.CustomThemeColorKey
import com.diekoma.ytune.constants.DarkModeKey
import com.diekoma.ytune.constants.DefaultOpenTabKey
import com.diekoma.ytune.constants.DisableScreenshotKey
import com.diekoma.ytune.constants.DynamicThemeKey
import com.diekoma.ytune.constants.FloatingToolbarBottomPadding
import com.diekoma.ytune.constants.FloatingToolbarHeight
import com.diekoma.ytune.constants.FloatingToolbarHorizontalPadding
import com.diekoma.ytune.constants.HasPressedStarKey
import com.diekoma.ytune.constants.LaunchCountKey
import com.diekoma.ytune.constants.MiniPlayerBottomSpacing
import com.diekoma.ytune.constants.MiniPlayerHeight
import com.diekoma.ytune.constants.MiniPlayerLastAnchorKey
import com.diekoma.ytune.constants.NavigationBarAnimationSpec
import com.diekoma.ytune.constants.PauseSearchHistoryKey
import com.diekoma.ytune.constants.PureBlackKey
import com.diekoma.ytune.constants.RemindAfterKey
import com.diekoma.ytune.constants.SYSTEM_DEFAULT
import com.diekoma.ytune.constants.SearchSource
import com.diekoma.ytune.constants.SearchSourceKey
import com.diekoma.ytune.constants.StopMusicOnTaskClearKey
import com.diekoma.ytune.constants.UseSystemFontKey
...
import com.diekoma.ytune.playback.DownloadUtil
import com.diekoma.ytune.playback.MusicService
import com.diekoma.ytune.playback.MusicService.MusicBinder
import com.diekoma.ytune.playback.PlayerConnection
import com.diekoma.ytune.playback.queues.LocalAlbumRadio
import com.diekoma.ytune.playback.queues.ListQueue
import com.diekoma.ytune.playback.queues.YouTubeAlbumRadio
import com.diekoma.ytune.playback.queues.YouTubeQueue
import com.diekoma.ytune.ui.component.BottomSheetMenu
import com.diekoma.ytune.ui.component.BottomSheetPage
import com.diekoma.ytune.ui.component.COLLAPSED_ANCHOR
import com.diekoma.ytune.ui.component.CreatePlaylistDialog
import com.diekoma.ytune.ui.component.DISMISSED_ANCHOR
import com.diekoma.ytune.ui.component.EXPANDED_ANCHOR
import com.diekoma.ytune.ui.component.FloatingNavigationToolbar
import com.diekoma.ytune.ui.component.IconButton
import com.diekoma.ytune.ui.component.LocalBottomSheetPageState
import com.diekoma.ytune.ui.component.LocalMenuState
import com.diekoma.ytune.ui.component.NetworkStatusBanner
import com.diekoma.ytune.ui.component.StarDialog
import com.mikepenz.markdown.m3.Markdown
import com.diekoma.ytune.ui.component.TopSearch
import com.diekoma.ytune.ui.component.rememberBottomSheetState
import com.diekoma.ytune.ui.component.shimmer.ShimmerTheme
import com.diekoma.ytune.ui.menu.YouTubeSongMenu
import com.diekoma.ytune.ui.player.BottomSheetPlayer
import com.diekoma.ytune.ui.screens.LOGIN_URL_ARGUMENT
import com.diekoma.ytune.ui.screens.Screens
import com.diekoma.ytune.ui.screens.buildLoginRoute
import com.diekoma.ytune.ui.screens.navigationBuilder
import com.diekoma.ytune.ui.screens.search.LocalSearchScreen
import com.diekoma.ytune.ui.screens.search.OnlineSearchScreen
import com.diekoma.ytune.ui.screens.settings.DarkMode
import com.diekoma.ytune.ui.screens.settings.DiscordPresenceManager
import com.diekoma.ytune.ui.screens.settings.NavigationTab
import com.diekoma.ytune.ui.theme.ArchiveTuneTheme
import com.diekoma.ytune.ui.theme.ColorSaver
import com.diekoma.ytune.ui.theme.DefaultThemeColor
import com.diekoma.ytune.ui.theme.extractThemeColor
import com.diekoma.ytune.ui.utils.appBarScrollBehavior
import com.diekoma.ytune.ui.utils.backToMain
import com.diekoma.ytune.ui.utils.resetHeightOffset
import com.diekoma.ytune.utils.SyncUtils
import com.diekoma.ytune.utils.Updater
...
import com.diekoma.ytune.utils.setAppLocale
import com.diekoma.ytune.viewmodels.HomeViewModel
import com.diekoma.ytune.viewmodels.NetworkBannerViewModel
...
class MainActivity : ComponentActivity() {
    ...
    private fun joinPendingTogetherIfReady() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            val displayName =
                runCatching { dataStore.data.first()[com.diekoma.ytune.constants.TogetherDisplayNameKey] }
                    .getOrNull()
                    ?.trim()
                    .orEmpty()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaunchedEffect(Unit) {
                ...
                com.diekoma.ytune.utils.UpdateNotificationManager.checkForUpdates(this@MainActivity)
            }
                    ...
                    val bottomSheetPageState = remember { com.diekoma.ytune.ui.component.BottomSheetPageState() }
                    val menuState = remember { com.diekoma.ytune.ui.component.MenuState() }
            ...
            val customThemeSeedPalette = remember(customThemeColorValue) {
                if (customThemeColorValue.startsWith("#")) {
                    ...
                    com.diekoma.ytune.ui.theme.ThemeSeedPaletteCodec.decodeFromPreference(customThemeColorValue)
                } else {
                    com.diekoma.ytune.ui.screens.settings.ThemePalettes
                        .findById(customThemeColorValue)
                        ?.let {
                            com.diekoma.ytune.ui.theme.ThemeSeedPalette(
                                primary = it.primary,
...
//                            "settings",
                    ...
                    CompositionLocalProvider(
                        ...
                        com.diekoma.ytune.ui.component.LocalBottomSheetPageState provides bottomSheetPageState,
                        com.diekoma.ytune.ui.component.LocalMenuState provides menuState,
                    ) {
                                        ...
                                        if (bottomNavigationBarHeight == 0.dp) {
                                            ...
                                            FloatingNavigationToolbar(
                                                ...
                                                onMusicRecognitionClick = if (shouldShowHomeShuffleButton) {
                                                    { navController.navigate(com.diekoma.ytune.ui.screens.musicrecognition.MusicRecognitionRoute) }
                                                } else null,
    ...
    private fun startMusicServiceSafely() {
        runCatching { startService(Intent(this, com.diekoma.ytune.playback.MusicService::class.java)) }
            .onFailure { reportException(it) }
    }
